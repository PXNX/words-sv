...
let relative = (file) => file;
{
  try {
    ...
    relative = (file) => path.relative(process2.cwd(), file);
  } catch {
  }
}
...
export {
  ...
  format_server_error as D,
  ENDPOINT_METHODS as E,
  parse as F,
  create_field_proxy as G,
  throw_on_old_property_access as H,
  INVALIDATED_PARAM as I,
  normalize_issue as J,
  set_nested_value as K,
  flatten_issues as L,
