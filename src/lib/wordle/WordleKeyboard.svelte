...
<style>
  ...
  .wordle-keyboard button { min-width:clamp(1.35rem,7.7cqw,2.55rem);height:clamp(2rem,10cqw,3.05rem);border:1px solid rgba(23,42,69,.28);background:#fffdf7;color:#172a45;font-family:'DM Sans',sans-serif;font-size:clamp(.6rem,2.7cqw,.82rem);font-weight:900;touch-action:manipulation;transition:transform .1s cubic-bezier(.23,1,.32,1),background .1s ease; }
  ...
  .wordle-keyboard button:active { transform:scale(.9);background:#e6a527; }
