...
<style>
  .wordle-keyboard { display:grid;gap:clamp(.24rem,1.1vw,.4rem);justify-content:center;padding-top:.1rem; }
  .wordle-keyboard>div { display:flex;justify-content:center;gap:clamp(.18rem,.9vw,.34rem); }
  .wordle-keyboard button { min-width:clamp(1.7rem,7.7vw,2.55rem);height:clamp(2.3rem,10vw,3.05rem);border:1px solid rgba(23,42,69,.28);background:#fffdf7;color:#172a45;font-family:'DM Sans',sans-serif;font-size:clamp(.63rem,2.7vw,.82rem);font-weight:900;touch-action:manipulation; }
  ...
  .wordle-utility button { min-width:clamp(2rem,8.6vw,2.8rem); }
  .wordle-utility .delete-key { min-width:clamp(2.35rem,10vw,3.2rem); }
