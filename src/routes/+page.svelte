<script lang="ts">
  ...
  const copy = {
    ...
    en: { label: 'WordCircle', hint: 'Trace the letters, one word at a time.', allDone: 'Puzzle solved', time: 'Solve time', continue: 'Continue', explain: 'Explain this word in Wiktionary', install: 'Install as an app', installHint: 'Available in this browser · play offline', language: 'Language', vocabulary: 'Level', includeLower: 'Include lower levels', appearance: 'Appearance', light: 'Light', dark: 'Dark', settings: 'Settings', vibration: 'Vibration', backwards: 'Spell backwards', settingsHint: 'Your word game, your mood.', round: 'Round', completed: 'Rounds solved', tracePrompt: 'TRACE', traceActive: 'PATH' }
  } as const;
