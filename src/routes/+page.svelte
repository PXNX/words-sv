...
<section class="home-view" dir={interfaceDirection} lang={settings.interfaceLocale} aria-label={labels.homeTitle}>
  ...
  {:else}
    ...
    <div class="home-games home-games--games">
      <article role="button" tabindex="0" onclick={() => selectMode('circle')} onkeydown={(event) => activateOnKey(event, () => selectMode('circle'))}><span class="home-icon" aria-hidden="true"><IconCrossword /></span><h2>{labels.modeCrossword}</h2><p>{labels.homeCircle}</p><button type="button" class="home-tutorial-link" onclick={(event) => { event.stopPropagation(); openTutorial('circle'); }} aria-label={labels.tutorial}><IconHelp aria-hidden="true" /></button></article>
      <article role="button" tabindex="0" onclick={() => void goto('/circle/definitions')} onkeydown={(event) => activateOnKey(event, () => void goto('/circle/definitions'))}><span class="home-icon" aria-hidden="true"><IconFactCheck /></span><h2>Kreuzwort</h2><p>Same crossword, but tap any square for that word's definition.</p></article>
      <article role="button" tabindex="0" onclick={() => selectMode('wordle')} onkeydown={(event) => activateOnKey(event, () => selectMode('wordle'))}><span class="home-icon" aria-hidden="true"><IconSpellcheck /></span><h2>{labels.modeWordle}</h2><p>{labels.homeWordle}</p><button type="button" class="home-tutorial-link" onclick={(event) => { event.stopPropagation(); openTutorial('wordle'); }} aria-label={labels.tutorial}><IconHelp aria-hidden="true" /></button></article>
      <article role="button" tabindex="0" onclick={() => selectMode('hangman')} onkeydown={(event) => activateOnKey(event, () => selectMode('hangman'))}><span class="home-icon" aria-hidden="true"><IconHangman /></span><h2>{labels.modeHangman}</h2><p>Guess the hidden word one letter at a time.</p><button type="button" class="home-tutorial-link" onclick={(event) => { event.stopPropagation(); openTutorial('hangman'); }} aria-label={labels.tutorial}><IconHelp aria-hidden="true" /></button></article>
    </div>
    <h2 class="home-group-heading">{labels.vocabularyGroup}</h2>
    <div class="home-games home-games--vocab">
      <article role="button" tabindex="0" onclick={() => selectMode('vocab')} onkeydown={(event) => activateOnKey(event, () => selectMode('vocab'))}><span class="home-icon" aria-hidden="true"><IconQuiz /></span><h2>{labels.wordQuiz}</h2><p>{labels.homeVocab}</p></article>
      <article role="button" tabindex="0" onclick={() => selectMode('pronunciation')} onkeydown={(event) => activateOnKey(event, () => selectMode('pronunciation'))}><span class="home-icon" aria-hidden="true"><IconMic /></span><h2>{labels.pronunciation}</h2><p>Listen to audio samples and practise speaking.</p></article>
      <article role="button" tabindex="0" onclick={() => selectMode('alltag')} onkeydown={(event) => activateOnKey(event, () => selectMode('alltag'))}><span class="home-icon" aria-hidden="true"><IconEmoji /></span><h2>{labels.alltag}</h2><p>Präpositionen, Zahlen und Farben für den Alltag.</p></article>
      <article role="button" tabindex="0" onclick={() => openGrammar('falsefriends')} onkeydown={(event) => activateOnKey(event, () => openGrammar('falsefriends'))}><span class="home-icon" aria-hidden="true"><IconSwapHoriz /></span><h2>{labels.grammarFalseFriends}</h2><p>Wörter, die täuschend ähnlich aussehen, aber etwas anderes bedeuten.</p></article>
    </div>
    <h2 class="home-group-heading">{labels.grammarGroup}</h2>
    <div class="home-games home-games--grammar">
      <article role="button" tabindex="0" onclick={() => openGrammar('fill')} onkeydown={(event) => activateOnKey(event, () => openGrammar('fill'))}><span class="home-icon" aria-hidden="true"><IconEditNote /></span><h2>{labels.grammarFill}</h2><p>{labels.homeGrammar}</p></article>
      <article role="button" tabindex="0" onclick={() => openGrammar('determine')} onkeydown={(event) => activateOnKey(event, () => openGrammar('determine'))}><span class="home-icon" aria-hidden="true"><IconFactCheck /></span><h2>{labels.grammarDetermine}</h2><p>Kasus, Genus, Numerus, Person und Tempus bestimmen.</p></article>
      <article role="button" tabindex="0" onclick={() => openGrammar('order')} onkeydown={(event) => activateOnKey(event, () => openGrammar('order'))}><span class="home-icon" aria-hidden="true"><IconSort /></span><h2>{labels.grammarOrder}</h2><p>Ordne Wörter und bilde einen korrekten Satz.</p></article>
    </div>
